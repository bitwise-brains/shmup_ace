...
.\tools\bitmap_conv.exe game.plt hextiles512.png -i -o .\data\hextiles512.bm
...
.\tools\bitmap_conv.exe game.plt powerup_1up.png -mc #FF00FF -i -o .\data\powerup_1up.bm
.\tools\bitmap_conv.exe game.plt powerup_special.png -mc #FF00FF -i -o .\data\powerup_special.bm
.\tools\bitmap_conv.exe game.plt powerup_weapon.png -mc #FF00FF -i -o .\data\powerup_weapon.bm
